...
python micro_diffusion/datasets/prepare/textcaps/convert.py --local_mds_dir "${datadir}/mds/"
...
accelerate launch --multi_gpu --num_processes $num_gpus micro_diffusion/datasets/prepare/textcaps/precompute.py --datadir "${datadir}/mds/" \
