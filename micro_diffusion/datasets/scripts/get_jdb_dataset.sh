...
python micro_diffusion/datasets/prepare/jdb/convert.py --images_dir "${datadir}/raw/test/imgs/" --captions_jsonl "${datadir}/raw/test/test_questions.jsonl" --local_mds_dir "${datadir}/mds/test/"
