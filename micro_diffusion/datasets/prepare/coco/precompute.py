...
from micro_diffusion.datasets.prepare.coco.base import (
    build_streaming_coco_precompute_dataloader,
)
...
accelerate launch --multi_gpu --num_processes 8 precompute.py \
    --datadir ./coco2014/mds/ \
    --savedir ./coco2014/mds_latents_sdxl1_dfnclipH14/ \
...
def main(args):
    ...
    dataloader = build_streaming_coco_precompute_dataloader(
