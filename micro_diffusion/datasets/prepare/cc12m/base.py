...
class StreamingCC12MDatasetForPreCompute(StreamingDataset):
    ...
    def __getitem__(self, index):
        ...
        caption = self.cap_processor.clean_caption(sample[self.caption_key])
        sample[self.caption_key] = caption
...
def build_streaming_cc12m_precompute_dataloader(
    ...
    **dataloader_kwargs,
    ...
    dataset = StreamingCC12MDatasetForPreCompute(
        streams=streams,
        shuffle=shuffle,
    ...
    def custom_collate(list_of_dict):
